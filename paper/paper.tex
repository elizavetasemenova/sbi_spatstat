...
the SBI toolkit---simulation-based calibration, marginal and \emph{conditional}
coverage---and show it passes on all parameters, while the widely used
point-estimate regressor is badly miscalibrated in a way that marginal coverage
alone would miss (Section~\ref{sec:calibration}).
...
\emph{marginally}, which Figure~\ref{fig:conditional} shows to be misleading.}
\label{fig:coverage}
\end{figure}
