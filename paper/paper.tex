...
preferential-sampling result (Section~\ref{sec:pref}) shows that once amortized
inference is \emph{trusted}, the likelihood-free interface makes non-standard
observation models tractable almost for free---thinning and imperfect detection,
aggregation to coarse regions (change of support), and adaptive designs are
immediate next steps. Amortizing over grid resolution and domain shape, and
